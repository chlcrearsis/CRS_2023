    ...
    public class ecp003
    {
        ...
        public void Fe_nue_sus(int cod_lib, int cod_per, int cod_plg, decimal mto_lim, decimal sal_act, int max_cuo, DateTime fec_exp)
        {
            try
            {
                ...
                cadena.AppendLine("INSERT INTO ecp003 VALUES (" + cod_lib + ", " + cod_per + ","+ cod_plg + ", '" + mto_lim + "', '" + sal_act + "', " + max_cuo + ", '" + DateTime.Parse(fec_exp.ToString()).ToString("d") + "', 'H')");
        ...
        public void Fe_edi_sus(int cod_lib, int cod_per, int cod_plg, decimal mto_lim,  int max_cuo, DateTime fec_exp)
        {
            ...
            {
                cadena = new StringBuilder();
                cadena.AppendLine("UPDATE ecp003 SET va_cod_plg = " + cod_plg + ", va_mto_lim = '" + mto_lim + "',   va_max_cuo = '" + max_cuo + "',  va_fec_exp = '" + DateTime.Parse(fec_exp.ToString()).ToString("d") + "' ");
