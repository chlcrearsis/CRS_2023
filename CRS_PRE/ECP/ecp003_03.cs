...
namespace CRS_PRE
{
    public partial class ecp003_03 : Form
    {
        ...
        private void Bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            msg_res = MessageBox.Show("Esta seguro de Editar la informacion?", "Edita Inscripción", MessageBoxButtons.OKCancel);
            if (msg_res == DialogResult.OK)
            {

                //Registrar 
                o_ecp003.Fe_edi_sus(int.Parse(tb_cod_lib.Text), cod_per, int.Parse(tb_cod_plg.Text), decimal.Parse(tb_mto_lim.Text),
