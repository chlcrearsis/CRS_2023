...
namespace CRS_PRE
{
    ...
    public partial class ads022_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads022_R01.SetParameterValue("vc_nom_emp", va_nom_emp);
            ads022_R01.SetParameterValue("vc_fec_ini", vp_fec_ini);
            ads022_R01.SetParameterValue("vc_fec_fin", vp_fec_fin);
            ads022_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
