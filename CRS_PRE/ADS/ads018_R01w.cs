...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads018 - Bitacora Inicio de Sesion                    */
    /*      Opción: Informe R01 - Reporte View                            */
    /*       Autor: JEJR - Crearsis             Fecha: 10-01-2024         */
    /**********************************************************************/
    public partial class ads018_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads018_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);
            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads018_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads018_R01.SetParameterValue("vc_nom_emp", va_nom_emp);
            ads018_R01.SetParameterValue("vc_usr_ini", vp_usr_ini);
            ads018_R01.SetParameterValue("vc_usr_fin", vp_usr_fin);
            ads018_R01.SetParameterValue("vc_fec_ini", vp_fec_ini);
            ads018_R01.SetParameterValue("vc_fec_fin", vp_fec_fin);
            ads018_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
