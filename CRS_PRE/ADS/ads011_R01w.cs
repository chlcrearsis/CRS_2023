...
namespace CRS_PRE
{
    ...
    /*  Aplicación: ads013 - Definición de Claves                         */
    /*      Opción: Informe R01 - Reporte View                            */
    /*       Autor: JEJR - Crearsis             Fecha: 06-12-2023         */
    /**********************************************************************/
    public partial class ads011_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads011_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);

            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads011_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads011_R01.SetParameterValue("vc_nom_emp", va_nom_emp);            
            ads011_R01.SetParameterValue("vc_mod_ini", vp_mod_ini);
            ads011_R01.SetParameterValue("vc_mod_fin", vp_mod_fin);
            ads011_R01.SetParameterValue("vc_ord_dat", vp_ord_dat);
            ads011_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
