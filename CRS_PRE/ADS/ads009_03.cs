...
namespace CRS_PRE
{
    ...
    public partial class ads009_03 : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            // Desplega Lista de Plantilla de Ventas
            Fi_des_pdv();
        }

        /// <summary>
        /// Desplega Lista de Plantilla de Ventas con y sin permisos
        /// </summary>
        private void Fi_des_pdv()
        {
            bool per_mis = true;
            dg_res_ult.Rows.Clear();
            // Obtiene Lista de Plantilla de Ventas
            Tabla = new DataTable();
