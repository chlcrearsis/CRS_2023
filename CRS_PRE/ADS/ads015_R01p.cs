...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class ads015_R01p : Form
    {
        public dynamic frm_pad;
        public int frm_tip;
        // Instancia
        private DataTable Tabla;
        private ads015 o_ads015 = new ads015();
        ...
        protected string Fi_val_dat()
        {
            ...
            {   // Verifica si hay algún módulo registrado
                Tabla = new DataTable();
                Tabla = o_ads015.Fe_lis_reg("T");
                if (Tabla.Rows.Count == 0)
                    return "NO hay ninguna regional registrado en la Base de Datos";
        ...
        private void bt_ace_pta_Click(object sender, EventArgs e)
        {
            ...
            // Obtiene Datos
            Tabla = new DataTable();
            Tabla = o_ads015.Fe_inf_R01(est_ado, ord_dat);

            // Genera el Informe
            ads015_R01w frm = new ads015_R01w{
                vp_est_ado = est_ado,
                vp_ord_dat = ord_dat
            };
