...
namespace CRS_PRE
{
    ...
    /**********************************************************************/
    public partial class ads013_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads013_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);

            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads013_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads013_R01.SetParameterValue("vc_nom_emp", va_nom_emp);            
            ads013_R01.SetParameterValue("vc_mod_ini", vp_mod_ini);
            ads013_R01.SetParameterValue("vc_mod_fin", vp_mod_fin);
            ads013_R01.SetParameterValue("vc_ord_dat", vp_ord_dat);
            ads013_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
