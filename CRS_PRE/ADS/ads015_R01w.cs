...
namespace CRS_PRE
{
    ...
    /*       Autor: JEJR - Crearsis             Fecha: 18-12-2022         */
    /**********************************************************************/
    public partial class ads015_R01w : Form
    {
        ...
        private void frm_Load(object sender, EventArgs e)
        {
            ...
            ads015_R01.SetDatabaseLogon(Program.gl_ide_usr, Program.gl_pas_usr, Program.gl_ser_bdo + "\\" + Program.gl_ins_bdo, Program.gl_nom_bdo);

            // Paso los datos obtenidos del procedimiento en la anterior ventana
            ads015_R01.SetDataSource(frm_dat);
            // Para enviar parametros directos al reporte (nombre del parametro en crystal report, valor que se enviara)
            ads015_R01.SetParameterValue("vc_nom_emp", va_nom_emp);
            ads015_R01.SetParameterValue("vc_est_ado", vp_est_ado);
            ads015_R01.SetParameterValue("vc_ord_dat", vp_ord_dat);
            ads015_R01.SetParameterValue("vc_ide_usr", Program.gl_ide_usr);
        }
